...
palindrome, as can be seen by examining the characters ―poor danisina droop‖ and 
...
1. to check whether given string is palindrome or not that uses a stack to determine whether a 
