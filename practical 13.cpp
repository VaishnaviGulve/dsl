...
may be made at either end. Obtain a data representation mapping a deque into a one-dimensional array. 
Write C++ program to simulate deque with functions to add and delete elements from either end of the 
deque.*/
...
int main()
{
	...
	while(ch!=6)
	{
		cout<<"1.Insert front 2.Insert rear 3.Delete front";
		cout<<"\n4.Delete rear5.Print6.Exit";
		cout<<"\nEnter your choice:: ";
		cin>>ch;
		switch(ch)
		{
